...
export default function SetAvatar() {
  ...
  const setProfilePicture = async () => {
      if(selectedAvatar === undefined){
          ...
          const user = await JSON.parse(localStorage.getItem("chat-app-login"));
          ...
          if(data.isSet){
              ...
              localStorage.setItem("chat-app-login", JSON.stringify(user));
              navigate("/");
          }
          else{
        ...
        isLoading ? <Container>
            ...
            <Container>
                <div className="title-container">
                    <h1>Pick avatar for your profile</h1>
                </div>
